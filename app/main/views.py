...
# The author attribute of the new post object is set to the expression
...
def post(id):
    ...
    if form.validate_on_submit():
        ...
        # special page number that is used to request the last page of comments
        # so that the comment just entered is seen on the page
    page = request.args.get('page', 1, type=int)
    if page == -1:
